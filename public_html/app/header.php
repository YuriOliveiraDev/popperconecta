...
/**
 * /app/header.php
 * Layout base: imprime <html>, <head>, <body> e o Topbar.
 * Suporta:
 * - $page_title (string)
 * - $html_class (string) -> vira class no <html>
 * - $extra_css (array de hrefs) -> links no <head>
 * - $extra_js_head (array de src) -> scripts no <head>
 */
...
<head>
  ...
  <?php
  // CSS mínimo base (se você preferir, pode deixar vazio e controlar tudo via $extra_css)
  // Aqui eu NÃO forço base.css automático pra você controlar por página.
  ?>
