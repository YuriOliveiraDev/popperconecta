...
<head>
  ...
  <link rel="stylesheet" href="/assets/css/rh_campaigns.css?v=<?= filemtime(__DIR__ . '/../assets/css/rh_campaigns.css') ?>" />
</head>
<body class="page">
...
<main class="container campaign-page">
  <div class="campaign-header">
    <div>
      ...
      <p class="campaign-subtitle">Cadastre campanhas com valor fixo para facilitar lançamentos individuais e em massa.</p>
    </div>

    <div class="campaign-header-actions">
      <a href="/admin/rh.php" class="btn-modern btn-modern--ghost">
        <span class="btn-modern__icon">←</span>
        Voltar
      </a>

      <button type="button" class="btn-modern btn-modern--accent" id="openCampaignModal">
        <span class="btn-modern__icon">＋</span>
        Nova campanha
      </button>
    </div>
  ...
  <section class="campaign-summary-grid">
    <div class="campaign-balance-card">
      ...
      <div class="campaign-balance-foot">
        ...
        <span class="campaign-balance-user"><?= htmlspecialchars((string)($u['name'] ?? ''), ENT_QUOTES, 'UTF-8') ?></span>
      </div>
    </div>
        ...
        <div class="form-grid">
          ...
          <div class="form-field form-field--full">
            ...
            <textarea
              ...
              rows="4"
              maxlength="255"
              placeholder="Ex.: Participação no curso mensal de desenvolvimento interno."
            ></textarea>
      ...
      <?php else: ?>
        <div class="campaign-grid" id="campaignGrid">
          <?php foreach ($campaigns as $index => $item): ?>
            ...
            <article
              class="campaign-item"
              data-title="<?= htmlspecialchars($name, ENT_QUOTES, 'UTF-8') ?>"
...
<script src="/assets/js/rh_campaigns.js?v=<?= filemtime(__DIR__ . '/../assets/js/rh_campaigns.js') ?>" defer></script>
