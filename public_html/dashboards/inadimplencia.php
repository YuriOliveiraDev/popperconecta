...
$html_class = 'page inadimplencia-page';
...
$extra_js_head = [
    '/assets/js/view-detect.js?v=' . filemtime(APP_ROOT . '/assets/js/view-detect.js'),
];
...
<main class="page-inad">
            ...
            <table class="inad-table">
                <thead>
                    <tr>
                        ...
                        <th class="th-sort" data-sort="vendedor_nome">Vend. <span class="sort-indicator"></span></th>
                        <th class="th-sort" data-sort="supervisor_nome">Superv. <span class="sort-indicator"></span></th>
                        <th class="th-sort" data-sort="inad_total">Inadimplente <span class="sort-indicator"></span></th>
                        <th class="th-sort" data-sort="faturado_periodo">Faturado <span class="sort-indicator"></span></th>
                        ...
                        <th class="th-sort" data-sort="maior_atraso_dias">Atraso <span class="sort-indicator"></span></th>
    ...
    <div class="modal" id="modalAvisoEmail" aria-hidden="true">
        ...
        <div class="modal__dialog modal__dialog--xl" role="dialog" aria-modal="true" aria-labelledby="modalAvisoTitulo">
                ...
                <div class="email-modal-grid">
                    <div class="email-form-side">
                        ...
                        <div class="form-row">
                            ...
                            <input type="text" id="emailAssunto" name="inad_notice_topic_locked" placeholder="Assunto do e-mail" readonly tabindex="-1" style="background:#f3f4f6; cursor:not-allowed;">
                        </div>

                        <div class="form-row">
                            <label for="emailMensagemExtra">Observação adicional</label>
                            <textarea id="emailMensagemExtra" rows="5" placeholder="Digite uma mensagem complementar..."></textarea>
                        </div>
