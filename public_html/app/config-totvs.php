...
// =========================
define('TOTVS_API_URL', 'https://tuffloglogistica122016.protheus.cloudtotvs.com.br:4050/api/wscmrelaut/v1/Consulta/000033');
define('TOTVS_API_USER', 'YURI.YANG');
define('TOTVS_API_PASS', 'Tufflog@2026');
...
// CHAMADA API TOTVS
// =========================
function callTotvsApi($url = null, $user = null, $pass = null, $disableSSL = null) {
    $url = $url ?? TOTVS_API_URL;
