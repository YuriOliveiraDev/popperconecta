...
const DASHBOARD_CATALOG = [
  'dash.comercial.faturamento' => ['label' => 'Faturamento', 'url' => '/dashboards/faturamento.php',           'group' => 'Comercial'],
  'dash.comercial.executivo'   => ['label' => 'Executivo',   'url' => '/dashboards/dashboard-executivo.php',   'group' => 'Comercial'],
  'dash.comercial.insight'     => ['label' => 'Insight',     'url' => '/dashboards/insight_comercial.php',     'group' => 'Comercial'],
